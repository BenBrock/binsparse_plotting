...
mtx_coo_noz = read_and_clean_benchmark_data('sloth/cold_write/br_mtx_noz.out')
binsparse_coo_noz = read_and_clean_benchmark_data('sloth/cold_write/br_coo_noz.out')
binsparse_coo_gzip1 = read_and_clean_benchmark_data('sloth/cold_write/br_coo_gz1.out')
binsparse_csr_noz = read_and_clean_benchmark_data('sloth/cold_write/br_csr_noz.out')
binsparse_csr_gzip1 = read_and_clean_benchmark_data('sloth/cold_write/br_csr_gz1.out')
...
plot_sizes(datasets, labels, ordering, title='Write Times (Cold) - SuiteSparse Matrix Collection', y_title='Runtime', x_title='Matrix Index', yticks = (ytick_data, ytick_labels))

print_speedups(datasets, labels, ordering, mtx_coo_noz)

print_statistics(['sloth/cold_write/br_coo_gz1.out', 'sloth/cold_write/br_coo_noz.out', 'sloth/cold_write/br_csr_gz1.out', 'sloth/cold_write/br_csr_noz.out', 'sloth/cold_write/br_mtx_noz.out'], ordering)
