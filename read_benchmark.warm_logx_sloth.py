...
plot_sizes_logx(mtx_noz_noaux, datasets, labels, ordering, title='Read Times (Warm) - SuiteSparse Matrix Collection', y_title='Runtime', x_title='Matrix Market File Size', yticks = (ytick_data, ytick_labels), xticks = (xtick_data, xtick_labels))

print_speedups(datasets, labels, ordering, mtx_coo_noz)

print_statistics(['sloth/warm_read/br_coo_gz1.out', 'sloth/warm_read/br_coo_noz.out', 'sloth/warm_read/br_csr_gz1.out', 'sloth/warm_read/br_csr_noz.out', 'sloth/warm_read/br_mtx_noz.out'], ordering)
