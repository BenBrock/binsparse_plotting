...
binsparse_coo_gzip1 = read_and_clean_benchmark_data('sloth/br_coo_gz1.out')
binsparse_coo_noz = read_and_clean_benchmark_data('sloth/br_coo_noz.out')
binsparse_csr_gzip1 = read_and_clean_benchmark_data('sloth/br_csr_gz1.out')
binsparse_csr_noz = read_and_clean_benchmark_data('sloth/br_csr_noz.out')
mtx_coo_noz = read_and_clean_benchmark_data('sloth/br_mtx_noz.2.out')
...
datasets = [binsparse_coo_noz, binsparse_coo_gzip1, binsparse_csr_noz, binsparse_csr_gzip1, mtx_coo_noz]
labels = ['sloth/br_coo_noz.out', 'br_coo_gz1.out', 'br_csr_noz.out', 'br_csr_gz1.out', 'br_mtx_noz.2.out']
...
print_statistics(['sloth/br_coo_gz1.out', 'sloth/br_coo_noz.out', 'sloth/br_csr_gz1.out', 'sloth/br_csr_noz.out', 'sloth/br_mtx_noz.2.out'], ordering)
