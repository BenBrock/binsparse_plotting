...
mtx_mt = read_and_clean_benchmark_data('sloth/cold_read/br_mtx_noz_multithreaded.out')

binsparse_coo_noz_mt = read_and_clean_benchmark_data('sloth/cold_read_mt/br_coo_noz.out')
binsparse_coo_gzip1_mt = read_and_clean_benchmark_data('sloth/cold_read_mt/br_coo_gz1.out')
binsparse_csr_noz_mt = read_and_clean_benchmark_data('sloth/cold_read_mt/br_csr_noz.out')
binsparse_csr_gzip1_mt = read_and_clean_benchmark_data('sloth/cold_read_mt/br_csr_gz1.out')
...
plot_sizes_logx(mtx_noz_noaux, datasets, labels, ordering, title='Parallel Read Times (Cold Cache)', y_title='Runtime', x_title='Matrix Market File Size', yticks = (ytick_data, ytick_labels), xticks = (xtick_data, xtick_labels), colors=colors, fname='out.pdf')
