...
plot_sizes_logx(mtx_noz_noaux, datasets, labels, ordering, title='Read Times (Cold) - SuiteSparse Matrix Collection', y_title='Runtime', x_title='Matrix Market File Size', yticks = (ytick_data, ytick_labels), xticks = (xtick_data, xtick_labels))
