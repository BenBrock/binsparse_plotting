...
datasets = [mtx_coo_noz, binsparse_coo_noz, binsparse_coo_gzip1, binsparse_csr_noz, binsparse_csr_gzip1]
labels = ['mtx_noz_noaux', 'binsparse_coo_noz', 'binsparse_coo_gzip1', 'binsparse_csr_noz', 'binsparse_csr_gzip1']

ytick_data = [0.001, 0.006, 0.03, 0.18, 1, 6, 30, 180]
ytick_labels = [pretty_print_time(time) for time in ytick_data]

plot_sizes(datasets, labels, ordering, title='Write Times (Warm) - SuiteSparse Matrix Collection', y_title='Runtime', x_title='Matrix Index', yticks = (ytick_data, ytick_labels))
